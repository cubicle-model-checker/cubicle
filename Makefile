...
INCLPATHS = $(FUNCTORYLIB) $(ZARITHLIB) $(OCAMLGRAPHLIB) $(Z3LIB) $(ZIPLIB) $(SIMPLEXLIB) -I common/ -I smt/
#-I alt-ergo
...
SMTCMO = smt/exception.cmo smt/symbols.cmo \
	 ...
	 smt/alt_ergo_file.cmo \
	 smt/z3wrapper.cmo smt/smt.cmo

#	 alt-ergo/altErgo.cmo \
	 smt/alt_ergo_file.cmo smt/alt_ergo_lib.cmo \
