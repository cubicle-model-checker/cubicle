...
val proc_as_subtype : Hstring.t list -> Hstring.t list ->
Interpret_types.interpret_value Interpret_types.Env.t ->
  Interpret_types.interpret_value Interpret_types.Env.t

val finalize_procs : Interpret_types.interpret_value Interpret_types.Env.t -> Hstring.t list ->
Ast.system -> Interpret_types.interpret_value Interpret_types.Env.t
