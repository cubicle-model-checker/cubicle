...
int F1 = 0, F2 = 0, F3 = 0, F4 = 0, F5 = 0, F6 = 0, F7 = 0, F8 = 0, CS = 0;
...
void * thr0(void *p)
{
	...
	CS = 1; assert(CS == 1);
	F1 = 1;
	while (F2 != 1 || F3 != 1 || F4 != 1 || F5 != 1 ||
	       F6 != 1 || F7 != 1 || F8 != 1);
	F1 = 0;
	while (F2 != 0 || F3 != 0 || F4 != 0 || F5 != 0 ||
	       F6 != 0 || F7 != 0 || F8 != 0);
    }
}
...
void * thr1(void *p)
{
    ...
    {
	F2 = 1;
	while (F1 != 1 || F3 != 1 || F4 != 1 || F5 != 1 ||
	       F6 != 1 || F7 != 1 || F8 != 1);
	CS = 2;
	F2 = 0;
	while (F1 != 0 || F3 != 0 || F4 != 0 || F5 != 0 ||
	       F6 != 0 || F7 != 0 || F8 != 0);
    }
}
...
void * thr2(void *p)
{
    ...
    {
	F3 = 1;
	while (F1 != 1 || F2 != 1 || F4 != 1 || F5 != 1 ||
	       F6 != 1 || F7 != 1 || F8 != 1);
	CS = 3;
	F3 = 0;
	while (F1 != 0 || F2 != 0 || F4 != 0 || F5 != 0 ||
	       F6 != 0 || F7 != 0 || F8 != 0);
    }
}
...
void * thr3(void *p)
{
    ...
    {
	F4 = 1;
	while (F1 != 1 || F2 != 1 || F3 != 1 || F5 != 1 ||
	       F6 != 1 || F7 != 1 || F8 != 1);
	CS = 4;
	F4 = 0;
	while (F1 != 0 || F2 != 0 || F3 != 0 || F5 != 0 ||
	       F6 != 0 || F7 != 0 || F8 != 0);
    }
}
