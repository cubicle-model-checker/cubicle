def generate_html_table(entries):
    ...
    colgroup.col-options, colgroup.col-nodes {
      width: 15%;
    }
    ...
    <table>
      ...
      <tr>
        ...
        <th colspan="2" class="options">Forward</th>
        <th colspan="2" class="options">Fuzz</th>
        <th class="invariants"><div>Invariants</div></th>
      </tr>
      <tr>
        <th></th>
        <th class="forward">Options</th>
        <th class="forward">Nodes</th>
        <th class="fuzz">Options</th>
        <th class="fuzz">Nodes</th>
        <th></th>
      </tr>
    '''
    ...
    for entry in entries:
        ...
        table_html += f"    <td class='options'>{fields[5].split(':')[1].strip()}</td>\n"
        table_html += f"    <td class='nodes'>{fields[6].split(':')[1].strip()}</td>\n"
        table_html += f"    <td style='text-align: center;'>{fields[7].split(':')[1].strip()}</td>\n"
        table_html += "  </tr>\n"
