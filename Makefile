...
INCLUDES = $(FUNCTORYLIB) -I common/ -I smt/

BFLAGS = -dtypes -g -thread $(INCLUDES) -annot
OFLAGS = -dtypes -thread $(INCLUDES) -annot
...
doc:
	...
	-intro doc/intro.txt $(INCLUDES) \
	$(filter-out lexer.mll parser.mly fake_functory.ml, $(FILES)) \
	$(COMMONFILES) $(SMTFILES)
...
archi:
	...
	$(INCLUDES) \
	$(filter-out lexer.mll parser.mly fake_functory.ml fake_functory.mli, $(FILES)) \
	$(COMMONFILES) smt/smt.mli
