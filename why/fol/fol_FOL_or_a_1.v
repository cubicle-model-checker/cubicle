...
(* Why3 goal *)
Theorem or_a : forall (f1:t) (f2:t) (f3:t), ((or (or f1 f2) f3) = (or f1
  (or f2 f3))).
intros f1 f2 f3.
...
apply model_or. right. apply model_or. left; auto.
apply model_or. right. apply model_or. right; auto.

intro.
apply model_or in H. destruct H.
apply model_or. left. apply model_or. left; auto.
apply model_or in H. destruct H.
apply model_or. left. apply model_or. right; auto.
