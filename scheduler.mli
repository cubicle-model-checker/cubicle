...
val trans : int TMap.t ref
val execTrans : int TMap.t ref
val notExecTrans : int TMap.t ref
val notSeenTrans : int TMap.t ref
...
val compare : (TMap.key * 'a) * 'b -> (TMap.key * 'c) * 'd -> int
